      ...
      {paymentStep === 'done' && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
           <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl border border-green-100">
              ...
              <p className="text-sm text-gray-600 mb-6">Hóa đơn mã <strong className="text-gray-900">{selectedInvoice.id}</strong> đã được thanh toán và cập nhật trạng thái "Đã thanh toán" trên hệ thống quản trị.</p>
              <button 
                onClick={() => {
                  setPaymentStep('idle');
                  setShowPaymentArea(false);
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="bg-white rounded-2xl shadow-xl border border-[#D29F91]/50 overflow-hidden relative">
                <div className="bg-[#8C4A3A] px-6 py-4 flex justify-between items-center text-white">
                  ...
                  <span className={`text-xs font-bold tracking-wider px-2.5 py-1 rounded border backdrop-blur ${
                    ...
                    <div className="border-t border-gray-200 pt-6 mt-6 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                         ...
                         <button 
                           ...
                           className={`p-4 rounded-xl flex flex-col items-center justify-center transition-all shadow-sm border-2 ${
                             paymentMethod === 'qr' ? 'border-[#8C4A3A] bg-orange-50/40' : 'border-gray-200 bg-white'
                           }`}
                         >
                         ...
                         <button 
                           ...
                           className={`p-4 rounded-xl flex flex-col items-center justify-center transition-all shadow-sm border-2 ${
                             paymentMethod === 'bank' ? 'border-[#8C4A3A] bg-orange-50/40' : 'border-gray-200 bg-white'
                           }`}
                         >
