...
const MOCK_LIST = [
   { id: 'DK-2023-01', branch: 'CN Quận 1', customer: 'Lê Văn Khách', phone: '0901234567', status: 'Đang xử lý' },
   { id: 'DK-2023-02', branch: 'CN Quận 3', customer: 'Nguyễn Thị B', phone: '0987654321', status: 'Đã xử lý', date: '21/10/2023', time: '09:00' },
