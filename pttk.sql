...
CREATE TABLE THONG_BAO_TAI_KHOAN (
	MaThongBao  CHAR(6)        PRIMARY KEY,
	MaHopDong   CHAR(6),
	MaNguoiNhan CHAR(6),
	NgayGui     DATETIME,
	NoiDung     NVARCHAR(500),
	TrangThai   NVARCHAR(100)  CHECK(TrangThai IN(N'Chưa gửi', N'Đã gửi', N'Lỗi'))
);
...
-- 41. THONG_BAO_TAI_KHOAN
INSERT INTO THONG_BAO_TAI_KHOAN (MaThongBao, MaHopDong, MaNguoiNhan, NgayGui, NoiDung, TrangThai) VALUES
('TB0001', 'HD0001', 'KH0001', '2026-06-05 10:00:00', N'Thông tin tài khoản: TK0008, TK0010 cho các thành viên nhóm', N'Đã gửi'),
('TB0002', 'HD0002', 'KH0005', '2026-06-10 11:00:00', N'Thông tin tài khoản: TK0012, TK0013, TK0014 cho các thành viên nhóm', N'Đã gửi');
GO